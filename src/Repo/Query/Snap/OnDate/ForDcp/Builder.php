    ...
    extends \Praxigento\Core\Repo\Query\Def\Builder
{
    ...
    /** Columns aliases. */
    const A_COUNTRY_CODE = \Praxigento\Downline\Data\Entity\Customer::ATTR_COUNTRY_CODE;
    const A_EMAIL = Cfg::E_CUSTOMER_A_EMAIL;
    ...
    public function getSelectQuery(\Praxigento\Core\Repo\Query\IBuilder $qbuild = null)
    {
        ...
        $cols = [
            self::A_MLM_ID => \Praxigento\Downline\Data\Entity\Customer::ATTR_HUMAN_REF,
            self::A_COUNTRY_CODE => \Praxigento\Downline\Data\Entity\Customer::ATTR_COUNTRY_CODE
        ];
